...
\begin{abstract}
    Horticultural robots designed for in-field use usually require a means of transport around farms or orchards.
    A common approach is to directly integrate a drive system, increasing overall complexity.
    ...
    Examples of such modules are robotic kiwifruit harvesters and kiwifruit pollination modules.
    ...
    The presented vehicle has traversed over \SI{10}{\kilo\meter} of orchard rows unassisted.
\end{abstract}
