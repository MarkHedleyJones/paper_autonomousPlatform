...
\label{sub:testing}
  ...
  \subsection{Row Following}
    ...
    \begin{figure}[htb]
        ...
        \caption{
            Distance between vehicle's tracking point and the mid-point of post/trunk pairs along the row.
            The average width of the row was \SI{4.35}{\meter}, which is the range of the y-axis.
