...
\label{sect:review}
    ...
    \subsection{Purpose-built Autonomous Vehicles in Agriculture}
        ...
        The use of simulation tools allowed the creators of BoniRob to develop and test their mobility system independent from the physical hardware.
    ...
    \subsection{Sensors for Row Based Navigation in Orchards}
        ...
        Lidar proved more accurate until the lidar's data transfer rate became a limiting factor.
        ...
        These reports suggest that traditional image based processing for navigation fails when the scene becomes complex or significant variations in lighting occur.
...
\section{Platform Design}
    ...
    \label{sect:mechanical}
        ...
        Modules designed to be carried by the platform require clearance from the canopy in addition to the height they occupy themselves.
    ...
    \label{sect:architecture}
        ...
        It too is an x86 based PC running Ubuntu, but uses a micro-ATX form-factor motherboard with a Nvidia GTX 1070 graphics card.
        ...
        Nodes are also used to transform or perform calculations on available data and pass it between nodes written in either C++ or Python.
        ...
        In addition to the drive commands generated by the navigation system, a safety rated wireless controller (HBC Radiomatic Eco) lets the operator generate commands via joystick.
...
\subsection{Sensor Selection}
    ...
    Selection factors were strengths and weaknesses in the context of orchard use, reported usage in literature, and availability at a suitable price.
...
% \subsection{Data Collection and Inspection}
 %    The sensors that seemed important to test, based on both the literature survey and the cost-benefit analysis were lidar, cameras and GPS.
    ...
    \subsubsection{In-orchard GPS Evaluation}
        ...
        The Ublox module was selected for its high sensitivity, internal low noise amplifier, and active circuitry for its 25mm square ceramic patch antenna.
        The OmniSTAR receiver was chosen for its high gain antenna (34 dB) which claims multi-path rejection.
        ...
        Based on these results, we consider GPS receivers similar to those trialled to be unsuitable for use in kiwifruit orchards.
    ...
    \subsubsection{In-orchard Camera Evaluation}
        ...
        Overall, 2D camera images were deemed suitable for object detection and classification.
...
\subsection{Sensor Demonstration by Prototype Algorithm}
    ...
    \subsubsection{Mapping and Localisation}
        ...
        As the lidar (Velodyne VLP-16) has 16 scanning layers, a conversion was necessary to produce the single plane of lidar data required by Gmapping.
        ...
        However, by using this approach the system would loose any benefit offered by the multiple scanning layers.
        ...
        The resulting points are then fed into Gmapping as a single plane with data from the platform's wheel encoders.
    ...
    \subsubsection{Kiwifruit Orchard Row Tracking}
        ...
        A row guidance system was developed and tested using the multi-layer to single-plane reduction technique developed earlier.
...
\subsection{Sensor Selection Conclusions}
    ...
    Further research in using this as a means of generating a path for row following is underway and is expected to be published in future.
