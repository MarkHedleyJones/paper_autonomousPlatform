...
\begin{abstract}
    ...
    This paper presents a modularised platform capable of carrying modules of up to \SI{1000}{\kilo\gram} under \SI{1.4}{\meter} high pergola style kiwifruit canopies.
...
\label{sub:testing}
  ...
  \subsection{Drive System}
    ...
    Drive system testing had the platform accelerated from a stand-still under manual control to its maximum speed on both flat ground and a \SI{3.5}{\degree} incline.
    ...
    During the flat acceleration test a peak power of between \SIrange{684}{770}{\watt}, and torque of between \SIrange{930}{1046}{\newton\meter} was calculated per wheel.
    During the climb acceleration test a peak power of between \SIrange{542}{610}{\watt}, and torque of between \SIrange{779}{876}{\newton\meter} was calculated per wheel.
...
\label{sect:discussion}
    ...
    The reported platform meets the previously specified requirements and has proved its usefulness during three pollination and harvesting seasons.
    However, during these operations the vehicle was operated under manual control because of the need to drive close to row boundaries.
    ...
    The vehicle's overall height is \SI{1.25}{\meter}, leaving \SI{0.15}{\meter} between it and the target ceiling height.
...
\section{Conclusion}
    ...
    The platform proved capable of carrying over twice the mass of similar platforms reported previously.
    The four wheel drive system with two individually actuated steering wheels is well suited for use in kiwifruit orchards.
    ...
    Using a map of manually adjusted row-end turns, the platform has navigated over \SI{10}{\kilo\meter} of orchard blocks using only wheel-encoders and a single multi-layer lidar.
    A significant amount of work was required to tune the row-end-turns, which has implications for commercial deployment.
    Row following tests using an algorithm based only on multi-layer lidar and IMU inputs proved to be repeatable to within $\pm$\SI{75}{\milli\meter} over five trials.
