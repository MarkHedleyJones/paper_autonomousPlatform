...
\title{A Modularised Platform for Autonomous Navigation in Kiwifruit Orchards}
...
%% Text of abstract
    ...
    Navigation sensor selection and in-orchard validation test results through two test orchard blocks are presented.
...
\label{sect:intro}
    ...
    \begin{enumerate}
        \item be resistant to water and dust,
...
\label{sect:design}
    ...
    % \label{sect:mechanical}
        ...
        This helped to ensure the platform meets its target load capacity of \SI{1000}{\kilo\gram}, while the vehicle itself weighs only \SI{850}{\kilo\gram} (including petrol engine, batteries, electronics and fuel).
    ...
    \label{sub:steering}
        ...
        Implementing four-wheel-steering would shift the pivot point to the vehicle's centre, roughly halving the radius.
        As headlands in kiwifruit orchards are sized for tractors with much larger turning radii than the developed platform this is unnecessary.
    ...
    \label{sub:drive}
        ...
        \label{eqn_f_accel}
        F_{total} &= F_{rr} + F_{gr} + F_{a}
        \end{align}
        Where $F_{roll}$ is the force due to rolling resistance; $F_{grade}$ is the a grade resistance force; and $F_{accel}$ is the force required to accelerate forward.
        A rolling resistance coefficient ($C_{rr}$) of was 0.04 chosen based on values found in common automotive handbooks.
        ...
        The required power ($P$) is calculated as follows:
        \begin{align}
        \label{eqn_f_power}
        \omega &= 2 \pi \times \frac{v}{2 \pi r} = \frac{v}{r}\\
        P &= \tau \omega
        \end{align}
        where $\omega$ is the wheel's angular velocity, $v$ is the vehicle velocity, and $\tau$ is torque.
        ...
        Each motor rated for \SI{6.4}{\kilo\watt} at \SI{96}{\volt} with a maximum speed of \SI{3000}{rev\per\min} and a torque of \SI{20.4}{\newton\meter}.
        ...
        % With a wheel diameter of \SI{730}{\milli\meter}, this limits the platform to a maximum speed of \SI{10.3}{\kilo\meter\per\hour}.
        ...
        % Based on these specifications the platform is capable of accelerating from a stand-still to its maximum speed at an incline of \SI{20}{\degree} whilst carrying a \SI{600}{\kilo\gram} payload in \SI{2.0}{\second}.
        ...
        These controllers are available commercially in four bus voltage options: 24-36V, 36-48V, 72V-80V, and 96V-110V.
        ...
        As approximately \SI{20}{\meter} of cabling is required to connect the motors and controllers to a common point on the vehicle, a \SI{96}{\volt} bus was used to reduce the required gauge of that cable.
    ...
    \label{sub:drive}
        ...
        The engine, compressor, and alternator are controlled and monitored electronically by a custom microcontroller based board.
    ...
    \subsection{Basic Tests}
        Testing of the vehicle's steering and stopping performance as well as its structural integrity were tested.
        In these situations a \SI{1100}{\kilo\gram} mass was strapped to the module area.
        No visible deflection of the vehicle's chassis or steering system was observed while under load.



        Loading of the chassis with a \SI{1100}{\kilo\gram} mass in its module area showed no observable deflection through the vehicle's structure.
        No degretation in steering performance was observed during static tests on dry concrete while loaded with this mass.

        Static steering tests done on a dry concrete while loaded with this mass also showed no observable difference in steering performance.
        Stopping
        Basic tests of the drive system and chassis strength were conducted by stopping the vehicle from full speed down a \SI{10}{\degree} slope while carrying the target mass of \SI{1100}{\kilo\gram}.
        Under three tests the vehicle stopped within a space of \SI{2.5}{\meter} in each case.
