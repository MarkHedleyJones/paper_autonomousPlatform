...
\label{sect:review}
    ...
    \subsection{Purpose-built Autonomous Vehicles in Agriculture}
        ...
        While that platform was designed to navigate kiwifruit orchards autonomously, its ability to do was not proven.
        ...
        The platform is comprised of two side modules and a wide centre-piece that bridges the side modules.
        The side modules contain the drive system, whereas the centre-piece is designed to be specific to the application.
        ...
        Many of the platforms reviewed, especially the more recent ones, made use of this system.
    ...
    \subsection{Sensors for Row Based Navigation in Orchards}
        ...
        Most recently, \cite{Sharifi2015} write about a method to generate a centre-lines from 2D images of orchard rows.
        ...
        Based on the high ongoing cost and increased receptin requirements we discount the use of an RTK-GPS system, but still consider the use of GPS in-orchard.
...
\section{Platform Design}
    ...
    \label{sect:mechanical}
        ...
        In future, the platform is expected to have the ability to pick and place bins autonomously while operating in the orchard.
        ...
        A power generation unit including a petrol engine (Honda GX-690), air compressor (Rotorcomp NK-1), and electrical alternator (Heinzmann PMSG-150) sits over the front pivoting axle.
        ...
        Electrical energy from the power generation unit is fed directly into the battery modules, making this a series-hybrid configuration.
        ...
        The batteries used (Winston/Thundersky WB-LYP90AHA) have a nominal voltage of \SI{3.2}{\volt} and a capacity of \SI{90}{\ampere\hour}.
