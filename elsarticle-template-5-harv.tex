...
\label{sect:nomenclature}
    \begin{description}
        ...
        \item{$\alpha$} - Slope angle (\SI{}{\degree})
        \item{Micro-ATX} - A computer motherboard form factor
        \item{B} - Nominal tyre width (\SI{}{\meter})
        \item{$C_{rr}$}- Rolling resistance coefficient (unit-less)
        \item{CAN} - Controller Area Network
        \item{$\Delta~v$} - Change in velocity (\SI{}{\meter\per\second})
        \item{E} - Tyre offset from axis of rotation (\SI{}{\meter})
        \item{$F_{accel}$} - Force required for mass acceleration (\SI{}{\newton})
        \item{$F_{grade}$} - Gradient force (\SI{}{\newton})
        \item{$F_{rolling}$} Force due to rolling resistance (\SI{}{\newton})
        \item{$F_{total}$} - Total force (\SI{}{\newton})
        \item{GLONASS} - Global Navigation Satellite System
        \item{GNSS} - Global Navigation Satellite System
        \item{GPS} - Global Positioning System
        \item{IMU} - Inertial Measurement Unit
        \item{m} - Mass (\SI{}{\kilo\gram})
        ...
        \item{$\tau$} - Torque (\SI{}{\newton\meter})
        \item{$u$} - Coefficient of friction (unit-less)
        \item{USB2} - Universal Serial Bus version 2
        \item{USB3} - Universal Serial Bus version 3
        \item{$\omega$} - Angular velocity (\SI{}{\radian\per\second})
    \end{description}
