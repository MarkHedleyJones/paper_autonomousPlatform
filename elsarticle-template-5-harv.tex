...
\label{sub:testing}
  ...
  \subsection{Row Following}
    ...
    We attribute this to a higher localisation uncertainty caused by limited sensor data at the beginning of each run.
    ...
    Sources of error were $\pm$\SI{1} pixel at each end of midpoint lines as well as measurement rounding errors (shown as error bars).
