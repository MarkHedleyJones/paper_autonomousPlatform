...
\label{sect:intro}
    ...
    The design can be instantiated in different sizes and forms, providing flexible and modular capabilities.
...
\label{sect:review}
    ...
    \subsection{Purpose-built Autonomous Vehicles in Agriculture}
        ...
        When publishing details of an autonomous vehicle in 1999, Tillett et~al.\@ cite difficulties dealing with variability in lighting and the environment as the reason no commercially ready vehicles were available at the time.
        ...
        Their platform is comprised of two side modules bridged by a wide centrepiece which contains instrumentation.
...
\section{Platform Design}
    ...
    \label{sect:mechanical}
        ...
        Implementing four-wheel-steering would shift the pivot point to the vehicle's centre, roughly halving the turning circle's radius.
        ...
        This capacity was chosen as the mass of a standard bin of kiwifruit can be as much as \SI{400}{\kilo\gram}, which leaves \SI{600}{\kilo\gram} for carrying modules.
        ...
        The authors suggest a pack voltage of \SI{48}{\volt} as a sensible alternative during a development phase as it bears a reduced risk of injury from electric shock.
        This voltage is supported across manufacturers of motors, motor controllers, and power converters.
        ...
        However, both robotic modules and the bin lifting mechanism require pneumatic air pressure to operate.
...
% \subsection{Data Collection and Inspection}
 %    The sensors that seemed important to test, based on both the literature survey and the cost-benefit analysis were lidar, cameras and GPS.
    ...
    \subsubsection{In-orchard Lidar Evaluation}
        ...
        Having 16 layers available meant it was possible to select the scan layer that gives the most useful viewing range.
        ...
        For the platform, a single-plane lidar has been fitted as an object detector for possible collisions, and a multi-layer lidar has been fitted for use in navigation and general object detection.
