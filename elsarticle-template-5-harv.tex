...
\label{sect:intro}
    ...
    Automation in kiwifruit harvesting and pollinating demands computer control, state-of-the-art manipulators, and advanced vision based detection systems.
    ...
    The design can be instantiated in different sizes and forms, providing a flexible modular capability.
    ...
    Key requirements for this platform are to: be capable of carrying a \SI{1000}{\kilo\gram} mass, pivot about the centre of the rear wheels, maximise the area available to task specific modules, and drive autonomously through pergola style kiwifruit orchards.
...
\section{Platform Design}
    ...
    \label{sect:mechanical}
        ...
        This satisfies the requirement for the vehicle to pivot about the centre of the rear wheels during tight turns.
        During such a turn, where the centre of rotation is between the rear wheels, its turning circle is equal to twice the vehicle's length.
        ...
        The chassis is made of laser cut and folded steel sections that have been welded together and powder coated.
        Finite element analysis was used during the design to identify weak areas  helped capability of supporting the target mass of \SI{1000}{\kilo\gram}.
        Unloaded, the machine has an estimated mass of \SI{850}{\kilo\gram}, including the power generation unit and batteries.
        Testing of the platform's drive system and chassis was done by driving around a test area with a \SI{1000}{\kilo\gram} mass strapped to the platform's module area.
