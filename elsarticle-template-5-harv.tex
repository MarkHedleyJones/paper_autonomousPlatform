...
\section{Platform Design}
    ...
    \label{sect:mechanical}
        ...
        The vehicle's design is shaped mostly by its role of carrying task specific modules and fruit bins through pergola style orchards.
        ...
        Existing commercial platforms suitable for use in horticulture exist, such as the Warthog from ClearPath Robotics, but the maximum payload, battey life, and vehicle geometry make them unsuitable.

        To maximise the space available to payload modules the platform must be low-slung at the point they attach.
        ...
        For steering, the angle of the vehicle's two front wheels are actuated independently following the Ackermann steering geometry principle.
        Steering actuation is performed by bruseless AC motors (Heinzmann PSM G100) mounted vertically above the drive wheels.
        These motors are rated for \SI{2.3}{\kilo\watt} at \SI{96}{\volt}, deliver \SI{7.32}{\newton\meter} of torque and have a maximum speed of \SI{3000}{rev\per\minute}. The output of these motors are fed through a planetary gearbox with a 64:1 fixed ratio, increasing torque to \SI{470}{\newton\meter} while reducing speed to \SI{46.9}{rev\per\min}.
        ...
        As the steering motors have incremental encoders built-in, but now means of absolute positioning, the front wheel angles must be homed at boot-up.
        Proxy sensors are used as a means of aligning the front wheels during the homing sequence.

        Independent control of the front wheels allows the vehicle to pivot about the centre of the rear wheels during tight turns.
        ...
        However, headlands in kiwifruit orchards are sized for tractors; tractors with two-wheel steering geometries.
        Implementing a two wheeled steering system removes the need to develop the ``non-trivial'' control strategies of a four-wheel steering system and increases usable area at the rear of the vehicle.
        ...
        As the operating speed within an orchard is \SI{5}{\kilo\meter\per\hour}, the lack of a dedicated suspension system is not required.
        A front pivoting axle ensures that all four wheels remain in contact with the ground.c
        ...
        The drive motors are each rated for \SI{6.4}{\kilo\watt} at \SI{96}{\volt} with a maximum speed of \SI{3000}{rev\per\min} and a torque of \SI{20.4}{\newton\meter}.
        ...
        In total, the drive system can continuously deliver \SI{25.6}{\kilo\watt} of power and \SI{3.26}{\kilo\newton\meter} of torque.
        ...
        A \SI{96}{\volt} bus was used to reduce the cabling requirements.
