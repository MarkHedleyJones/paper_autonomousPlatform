...
\label{sect:review}
    ...
    % A simple platform presented by \citep{Blasco2002} is nothing more than a simple frame, without the ability to turn and a top speed of \SI{0.8}{\kilo\metre\per\hour}.

    \Citep{Pedersen2002} presents an Ackermann based autonomous robot designed for weed mapping that has a top speed of \SI{6}{\kilo\meter\per\hour}.
