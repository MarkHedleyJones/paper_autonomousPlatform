...
\label{sect:nomenclature}
    \begin{description}
        \item{3D} - 3 dimensional
        \item{A} - Amps
        \item{$\alpha$} - Slope angle
        \item{Micro-ATX} - A computer motherboard form factor
        \item{B} - Nominal tyre width
        \item{$C_{rr}$}- Rolling resistance coefficient
        \item{CAN} - Controller Area Network
        \item{DC} - Direct Current
        \item{\SI{}{\degree}} - Degree
        \item{$\Delta~v$} - Change in velocity
        \item{E} - Tyre offset from axis of rotation
        \item{$F_{accel}$} - Force required for mass acceleration
        \item{$F_{grade}$} - Gradient force
        \item{$F_{rolling}$} Force due to rolling resistance
        \item{$F_{total}$} - Total force
        \item{G} - Gravity
        \item{GLONASS} - Global Navigation Satellite System
        \item{GNSS} - Global Navigation Satellite System
        \item{GPS} - Global Positioning System
        \item{IMU} - Inertial Measurement Unit
        \item{\SI{}{\kilo\gram}} - Kilogram
        \item{\SI{}{\kilo\meter}} - Kilometer
        \item{\SI{}{\kilo\meter\per\hour}} - Kilometers per hour
        \item{\SI{}{\kilo\newton}} - Kilonewton
        \item{\SI{}{\kilo\pascal}} - Kilopascales
        \item{\SI{}{\kilo\watt}} - Kilowatts
        \item{\SI{}{\kilo\watt\hour}} - Killowatt hours
        \item{\SI{}{\kilo\meter}} - Meters
        \item{m} - Mass
        \item{\SI{}{\milli\meter}} - Millimeters
        \item{\SI{}{\milli\second}} - Milliseconds
        \item{\SI{}{\meter\per\second}} - Meters per second
        \item{\SI{}{\newton}} - Newtons
        \item{\SI{}{\newton\meter}} - Newton meters
        \item{PC} - Personal computer
        \item{$\pi$} - Pi
        \item{PSA} - Pseudomonas syringae pv. actinidiae (bacteria that infects kiwifruit vines)
        \item{\SI{}{\radian\per\second}} - Radians per second
        \item{\SI{}{rev\per\minute}} - Revolutions per minute
        \item{ROS} - Robot Operating System
        \item{RTK-GPS} - Real-time Kinematic Global Positioning System
        \item{SLAM} - Simultaneous Localisatoin And Mapping
        \item{$t$} - Time
        \item{$\tau$} - Torque
        \item{$u$} - Coefficient of friction
        \item{USB2} - Universal Serial Bus version 2
        \item{USB3} - Universal Serial Bus version 3
        \item{\SI{}{\volt}} - Volts
        \item{VAC} - Volts Alternating Current
        \item{VDC} - Volts Direct Current
        \item{\SI{}{\watt}} - Watts
        \item{$\omega$} - Wheel force
    \end{description}
