...
\label{sect:intro}
    ...
    Because the canopy of a pergola style kiwifruit orchard can droop as low as \SI{1.6}{\meter} to the ground under full fruit loading, standard vehicles are unsuitable for use this environment.
    ...
    \begin{enumerate}
        ...
        \item have a maximum speed of \SI{10}{\kilo\meter\per\second},
...
\label{sect:review}
    ...
    \subsection{Purpose-built Autonomous Vehicles in Agriculture}
        ...
        BoniRob represents the first of the more general purpose platforms designed to carry modularised payloads, albeit with a limited capacity.
        ...
        Only the platform of \cite{Scarfe2012} had the capacity for carrying fruit bins, which is specific to kiwifruit and apple orchards.
    ...
    \subsection{Sensors for Row Based Navigation in Orchards}
        ...
        These results are promising for use in kiwifruit orchards, where the conditions are similar, and where the target speed is only \SI{1.39}{\meter\per\second} (\SI{5.0}{\kilo\meter\per\hour}).
