...
\label{sub:testing}
    ...
    \begin{figure}[htb]
        ...
        \caption{
            Plot showing the number of interventions during tuning of row-end turns.
            In most cases an intervention resulted in additional tuning of aborted row end turns.
        }
        \label{fig:block_traversal}
    \end{figure}
