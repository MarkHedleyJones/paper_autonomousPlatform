...
\nomenclature{$\alpha$}{Slope angle (\SI{}{\degree})}
...
\nomenclature{$C_{rr}$}{Rolling resistance coefficient}
\nomenclature{$F_{accel}$}{Force required for mass acceleration (\SI{}{\newton})}
\nomenclature{$F_{grade}$}{Gradient force (\SI{}{\newton})}
\nomenclature{$F_{rolling}$}{Force due to rolling resistance (\SI{}{\newton})}
\nomenclature{$F_{total}$}{Total force (\SI{}{\newton})}
\nomenclature{$u$}{Coefficient of friction (unitless)}
\nomenclature{3D}{3 dimensional}
\nomenclature{B}{Nominal tyre width (\SI{}{\meter})}
\nomenclature{CAN}{Controller Area Network}
\nomenclature{E}{Tyre offset from axis of rotation (\SI{}{\meter})}
\nomenclature{GLONASS}{Global Navigation Satellite System}
\nomenclature{GNSS}{Global Navigation Satellite System}
\nomenclature{GPS}{Global Positioning System}
\nomenclature{IMU}{Inertial Measurement Unit}
\nomenclature{MicroATX}{A computer motherboard form factor}
...
\nomenclature{RTK-GPS}{Realtime Kinematic Global Positioning System}
\nomenclature{SLAM}{Simultaneous Localisatoin And Mapping}
\nomenclature{USB2}{Universal Serial Bus version 2}
\nomenclature{USB3}{Universal Serial Bus version 3}
