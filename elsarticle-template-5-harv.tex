...
\label{sub:testing}
  ...
  \subsection{Row Following}
    ...
    \begin{figure}[htb]
        ...
        \caption{
            Vehicle deviation from the row's centre during five row-following trials.
            Each colour corresponds to the paths presented in Figure~\ref{fig:row_following_paths}.
            Error bars represent a $\pm$\SI{1}{pixel} error ($\pm$\SI{0.274}{\meter}) from the rendered SLAM map, used to calculate the row mid-points.
            ...
            % Distance from the row's centre is calculated by finding the midpoint between each pair of posts or trunks.
        }
