...
\label{sect:autonomous}
    ...
    \label{sub:rowfollowing}
      ...
      The process involved evaluating groupings of four post/trunks to find those likely to represent pairs of adjacent post/trunks on either side of the row -- forming a rectangle.
      ...
      Again using a cost function, possible lattice sections were evaluated based on the regularity of areas of the rectangles they were made up of, the lattice's overall linearity, and the number of rectangles they contained.
...
\label{sect:discussion}
    ...
    Matching this with the corresponding post/trunk pair in Figure~\ref{fig:row_following_paths_segmented} shows the placement of the right-hand post/trunk is certainly a contributing factor.
    ...
    This data was generated by the SLAM package (Cartographer) by matching subsequent lidar frames.
    ...
    In the event that the vehicle required repair or maintenance work during a harvesting or pollination season, the modules could be mounted on a trailer and towed behind a quad-bike until the vehicle was ready.
...
\section{Conclusion}
    We presented a platform designed specifically for autonomously transporting task-specific modules and kiwifruit bins through pergola-style kiwifruit orchards.
