...
\label{sub:testing}
  ...
  \subsection{Row Following}
    ...
    In this trial the row-following algorithm was similar to that reported in \cite{Bell2016}, but with the following alterations.
    ...
    This involved first filtering out points that were expected to represent the ground and using them to create a surface representing the ground.
    ...
    Further processing checked the geometric relationship of the remaining points and made predicitons about the location of post/trunk pairs.
    ...
    Detection of the \textit{out\_of\_row} condition was calculated based the vehicle's proximity to the farterest post/trunk pair.
    Once there were no post/trunk pairs further than \SI{2.5}{\meter} in front of the vehicle, the vehicle would stop.
    This algorithm made no attempt to avoid obstacles or turn between rows.
