...
\label{sect:intro}
    ...
    Automated kiwifruit harvesting and pollination modules incoporate computer controlled manipulators and real-time machine-vision systems utilising computationally expensive neural-network based image processing.
...
\label{sect:review}
        ...
        % Like the previously mentioned robots, its payloads are oriented toward ground based crops and its carrying capacity (\SI{200}{\kilo\gram}) is insufficient.
...
\label{sect:discussion}
    ...
    % The structure of the pergola style kiwifruit orchard made generating odometry information directly from lidar scans reliable enough to replace wheel encoders and IMU based odometry.
    % The odometry was generated by the SLAM package (Cartographer) by matching subsequent lidar frames.
