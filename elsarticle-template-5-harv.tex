...
\label{sect:intro}
    ...
    These systems are bulky and have specific geometric requirements dictated by the kiwifruit growing systems.
...
\label{sect:design}
    ...
    \label{sub:power}
        ...
        The controllers provide battery voltage and current limits as well as the ability to reduce effort as the battery becomes fully charged.
...
\label{sub:testing}
  ...
  \subsection{Drive System}
    ...
    Drive system testing had the platform accelerated from a stand-still under manual control to its maximum speed on both level ground and up a \SI{3.5}{\degree} incline.
  ...
  \subsection{Turning Circle}
    ...
    The authors put this discrepancy down to the quality of the angular calibration of the front wheels.
  ...
  \subsection{Row Following}
    ...
    The SLAM package used was Cartographer (version 1.0) used as a ROS package that produced both the map and the vehicle's trajectory information \citep{Hess2016}.
    ...
    Quick measurements conducted on grass showed an imbalance of approximately \SI{5}{\percent} between the rear wheels depending on ground slope.
...
\label{sect:discussion}
    ...
    The series-hybrid configuration allowed the vehicle to drive and provide power to subsystems without running the petrol engine.
...
\section{Conclusion}
    ...
    The four wheel drive system with two individually-actuated steering wheels proved to be well suited for use in and around kiwifruit orchards.
