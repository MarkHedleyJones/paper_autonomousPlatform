...
\label{sect:design}
    ...
    % \label{sect:mechanical}
        ...
        Finite element analysis was used during the design phase to help identify areas needing to be strengthened.
        This helped to ensure the platform meets its target load capacity of \SI{1000}{\kilo\gram}.
    ...
    \label{sub:steering}
        ...
        As the axis of steering rotation lies directly through the centre of the wheel, $E$ is 0.
    ...
    \subsection{Tests}
        Tests of the drive system and chassis strength were conducted by stopping the vehicle from full speed down a \SI{10}{\degree} slope while carrying the target mass of \SI{1000}{\kilo\gram}.
    ...
    \subsection{Discussion}
        ...
        While essential for safety, these procedures added complexities and delays during development that could have been avoided.
