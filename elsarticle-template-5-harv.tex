...
\label{sub:testing}
  ...
  \subsection{Row Following}
    ...
    Quick measurements conducted on grass showed an imbalance of approximately \SI{5}{\percent} between the rear wheels depending on the slope angle (which was not measured).
