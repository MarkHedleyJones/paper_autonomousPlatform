...
% \subsection{Data Collection and Inspection}
 %    The sensors that seemed important to test, based on both the literature survey and the cost-benefit analysis were lidar, cameras and GPS.
    ...
    \subsubsection{Camera Data Collection}
        ...
        Three varieties of camera were tested: time-of-flight, 3D stereo, and traditional color camera.
        ...
        It combines a stereo pair of infra-red cameras with a color camera.
        ...
        Finally, traditional color cameras trialled were the Basler Dart daA1600-60uc, Flir CM3-U3-13S2C-CS, and Logitech C920 cameras.
        ...
        Overall, the color camera images were the best suited for object detection and classification.
        This was verified by processing the data using readily accessible detection algorithms.

    %     % My rewrite before I realised the RealSense isn't a time-of-flight camera.

    %     % Two time-of-flight cameras were evaluated: a Basler TOF640-20GM-850NM and an Intel RealSense R200.
    %     % The Basler sensor provides both depth and return signal data at a resolution of 640 by 480 pixels.
    ...
    %     % The Intel sensor had a camera resolution of 640 by 480 pixels, but a maximum depth resolution of 480x360.
    %     % The second sensor exhibited a complete loss of range data in both bright sunlight and overcast conditions.
    %     % Both sensors were deemed unfit for use in important navigation functions such as obstacle detection.

    %     % Jamie's original content
    ...
    % \subsubsection{Camera Data Collection}
    %     Data was collected from a Basler Dart daA1600-60uc, Flir CM3-U3-13S2C-CS, and a Logitech C920 web-camera.
    ...
    % 	In addition, these cameras did not provide a hardware trigger interface, which would be important if the cameras were used for stereo vision.
    % 	No image quality issues were noticed with the Basler and Flir sensors; however, the Basler camera was favored for its later model image sensor.
    ...
    %     Additionally, a stereo vision based Intel RealSense R200 camera was tested.
    %     % ////////////////
    %     % Integrate the RealSense camera into this section
    %     % \\\\\\\\\\\\\\\\
