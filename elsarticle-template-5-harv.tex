...
\label{sub:testing}
  ...
  \subsection{Turning Circle}
    ...
    The distance between the markers was measured at \SI{6.45}{\meter}, giving a turning radius of \SI{3.23}{\meter}.

  \subsection{Bin Lifter}

    Basic testing of the bin lifting mechanism with a mass mounted to a wooden pallet was made.
    ...
    To raise the load, pneumatic pressure of \SI{800}{\kilo\pascal} was applied to one port of each cylinder while the other port was opened to atmosphere.
    Lowering was done by simply opening both ports to atmosphere, allowing the load to descend under its own weight.
    The test load was lifted and lowered a total of five times under observation.
    ...
    At its lower position, signs of imbalance between the two cylinders was evident which caused minor shuddering.
    The cause was likely to be the plastic sleeve bearings in the linkages being too tight.
    This was also evident when hand actuating the lifter.
