...
\label{sect:intro}
    ...
    \begin{figure}[htb]
        \centering
        \includegraphics[width=\linewidth]{imgs/suzy_general.jpg}
        \caption{
...
\label{sect:design}
        \begin{figure}[htb]
            \centering
            \includegraphics[width=\linewidth]{imgs/AMMP-All-Labelled.pdf}
        ...
        \begin{figure}[htb]
            \centering
            \includegraphics[width=0.6\linewidth]{imgs/AMMP-Chassis-1-20.pdf}
    ...
    \label{sub:power}
        ...
        \begin{figure}[htb]
            \centering
            \includegraphics[width=\linewidth]{imgs/full-system-diagram_v1.pdf}
    ...
    \label{sect:architecture}
        ...
        \begin{figure}[htb]
            \centering
            \includegraphics[width=\linewidth]{imgs/diagram_v5.pdf}
            \caption{
        ...
        \begin{figure}[htb]
            \centering
            \includegraphics[width=\linewidth]{imgs/software_v2.pdf}
...
\label{sect:sensors}
    ...
    \subsection{Camera}
        ...
        \begin{figure}[htb]
            \centering
            \includegraphics[width=\linewidth]{imgs/camera_comparison.pdf}
            \caption{
    ...
    \subsection{Lidar}
        ...
        \begin{figure}[htb]
            \centering
            \includegraphics[width=\linewidth]{imgs/canopy_data.pdf}
            \caption{
        ...
        \begin{figure}[htb]
            \centering
            \includegraphics[width=\linewidth]{imgs/concave_slope_v4.pdf}
            \caption{
    ...
    \subsection{GNSS}
        ...
        \begin{figure}[htb]
            \centering
            \includegraphics{imgs/gps_path.pdf}
            \caption{
...
\label{sect:autonomous}
    ...
    \begin{figure}[htb]
        \centering
        \includegraphics[width=\linewidth]{imgs/flowchart.pdf}
        \caption{
    ...
    \begin{figure}[htb]
        \centering
        \includegraphics[width=\linewidth]{imgs/suzy_turning.jpg}
        \caption{
...
\label{sub:testing}
  ...
  \subsection{Drive System}
    ...
    \begin{figure}[htb]
        \centering
        \includegraphics{imgs/graph_acceleration.pdf}
        \caption{
  ...
  \subsection{Turning Between Rows}
    ...
    \begin{figure}[htb]
        \centering
        \includegraphics{imgs/bateman.pdf}
        \caption{
    ...
    \begin{figure}[htb]
        \centering
        \includegraphics{imgs/newnham.pdf}
        \caption{
  ...
  \subsection{Pure Row-following}
    ...
    \begin{figure}[htb]
        \centering
        \includegraphics[width=\linewidth]{imgs/paths2.pdf}
        \caption{
    ...
    \begin{figure}[htb]
        \centering
        \includegraphics[width=\linewidth]{imgs/segmented_analysis_with_centres.pdf}
        \caption{
    ...
    \begin{figure}[htb]
        \centering
        \includegraphics{imgs/row_tracking_averages.pdf}
        \caption{
    ...
    \begin{figure}[htb]
        \centering
        \includegraphics{imgs/row_tracking_repeatability.pdf}
        \caption{
    ...
    \begin{figure}[htb]
        \centering
        \includegraphics{imgs/paths_end_points.pdf}
        \caption{
