...
\label{sect:intro}
    ...
    While publishing details of a general purpose robotics platform for field use, the authors stated that ``since the robot development already includes a high complexity, the application itself should be of comparably low complexity'' \citep{Ruckelshausen2009}.
    ...
    The presented platform simply needs to navigate through orchards while providing power to removable modules.
...
\label{sect:design}
    ...
    \label{sub:steering}
        ...
        The two wheeled steering system removes the need to develop the ``non-trivial'' control strategies encountered by \cite{Bak2004}.
    ...
    \label{sect:architecture}
        ...
        This forces them to accept drive commands via their CAN interface which are generated from ROS nodes on the Platform PC.
