...
\author{M. H. Jones, M. Seabright, J. Barnett, A. Scarfe, Prof. M. Duke}
...
Previous work on automated harvesting of kiwifruit \citep{Scarfe2012}.
...
\label{sect:hardware}
Forward and upwards facing LiDAR are used for navigation and detection of canopy.
GPS has been unreliable in kiwifruit orchards, probably due to the canopy itself and surrounding wind-breaks.

\section{Software architecture}
\label{sect:software}
ROS used as the basis for platform control.
