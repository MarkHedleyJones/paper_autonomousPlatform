...
\label{sect:review}
    ...
    \subsection{Sensors for Row Based Navigation}
        ...
        % Sentence here relating to how whenever traditional image processing is used, it always ends up not being able to cope when the lighting changes.
        ...
        % \cite{Torres2011} Orchard row detection using camera (640x480)
